...
namespace NavMeshPlus.Components.Editors
{
    ...
    class NavMeshSurfaceEditor : Editor
    {
        ...
        Bounds GetBounds()
        {
            var navSurface = (NavigationSurface)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (NavigationSurface navSurface in targets)
            {
        ...
        static void RenderGizmoSelected(NavigationSurface navSurface, GizmoType gizmoType)
        {
        ...
        static void RenderGizmoNotSelected(NavigationSurface navSurface, GizmoType gizmoType)
        {
        ...
        static void RenderBoxGizmo(NavigationSurface navSurface, GizmoType gizmoType, bool selected)
        {
        ...
        public static void CreateNavMeshSurface(MenuCommand menuCommand)
        {
            ...
            go.AddComponent<NavigationSurface>();
