...
namespace NavMeshPlus.Components
{
    ...
    public class NavigationSurface : MonoBehaviour
    {
        ...
        static readonly List<NavigationSurface> s_NavMeshSurfaces = new List<NavigationSurface>();
        public INavMeshExtensionsProvider NevMeshExtensions { get; set; } = new NavMeshExtensionsProvider();

        public static List<NavigationSurface> activeSurfaces
        {
        ...
        static void Register(NavigationSurface surface)
        {
#if UNITY_EDITOR
        ...
        static void Unregister(NavigationSurface surface)
        {
        ...
        bool UnshareNavMeshAsset()
        {
            ...
            var prefab = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource(this) as NavigationSurface;
