...
namespace NavMeshPlus.Extensions
{
    ...
    public class CollectSourcesCache2d : NavMeshExtension
    {
        ...
        public override void CollectSources(NavigationSurface surface, List<NavMeshBuildSource> sources, NavMeshBuilderState navMeshState)
        {
            _lookup.Clear();
            IsDirty = false;
            _state?.Dispose();
        ...
        public override void PostCollectSources(NavigationSurface surface, List<NavMeshBuildSource> sources, NavMeshBuilderState navNeshState)
        {
