...
namespace NavMeshPlus.Extensions
{
    ...
    public class CollectSources2d: NavMeshExtension
    {
        ...
        public override void CalculateWorldBounds(NavigationSurface surface, List<NavMeshBuildSource> sources, NavMeshBuilderState navNeshState)
        {
        ...
        private static Bounds CalculateGridWorldBounds(NavigationSurface surface, Matrix4x4 worldToLocal, Bounds bounds)
        {
            ...
            {
                var lbounds = NavigationSurface.GetWorldBounds(worldToLocal * tilemap.transform.localToWorldMatrix, tilemap.localBounds);
